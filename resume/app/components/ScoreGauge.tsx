...
const ScoreGauge = ({ score = 75, customColors }: { score: number, customColors?: { primary: string; secondary: string; accent: string; background: string } }) => {
    ...
    const secondaryColor = customColors?.secondary || '#fca5a5';
